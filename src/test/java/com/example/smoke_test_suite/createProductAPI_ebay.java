...
public class createProductAPI_ebay {
    ...
    public static void createProduct(String sku, String name, String path) throws IOException {
       ...
       String response = given().
                ...
                header("wix-site-id", "d7a7642b-21c0-460b-a409-9d3103916f64").
    ...
    public static void createImage(String ID,String productID) throws IOException {
        ...
        String json = generateStringFromResource("src/test/java/com/example/jsonFiles/image.json");
